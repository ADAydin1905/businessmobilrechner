 ...
 *
 * Diese Datei wird per <script src="tarife.js"> eingebunden und funktioniert
 * auch beim Oeffnen per Doppelklick (file://), wo fetch() blockiert waere.
 * Inhalt ist identisch zu tarife.json. Beim Hosten ueber GitLab Pages / einen
 * Webserver wird stattdessen automatisch tarife.json per fetch geladen.
 *
 * Bearbeitung erfolgt ueber das Admin-Panel des Rechners. Nach dem Export
 * beide Dateien (tarife.js UND tarife.json) nach GitLab committen.
 */
window.TARIFE_DATA = {
  "_meta": {
    "schemaVersion": "1.0",
  ...
  "tarife": {
    ...
    "Business Mobil L eco": {
      ...
      "leistungen": [
        ...
        "Telefonie Flat innerhalb Deutschlands und ins Ausland: EU Länder + Großbritannien, Schweiz & Türkei",
        "118 GB EU Roaming inkl. Großbritannien und Schweiz",
    ...
    "Business Mobil XL eco": {
      ...
      "leistungen": [
        "Unbegrenzt HighSpeed Datenvolumen in Deutschland ( LTE/5G )",
        "Telefonie Flat innerhalb Deutschlands und ins Ausland: EU Länder + Großbritannien, Schweiz, USA, Kanada & Türkei",
        "160 GB EU Roaming inkl. Großbritannien und Schweiz, USA, Kanada & Türkei",
    ...
    "Business Card XL eco": {
      ...
      "leistungen": [
        "Unbegrenzt HighSpeed Datenvolumen ( LTE/5G )",
        "Telefonie Flat innerhalb Deutschlands und ins Ausland: EU Länder + Großbritannien, Schweiz, USA, Kanada & Türkei",
        "160 GB EU Roaming inkl. Großbritannien, Schweiz, USA, Kanada & Türkei",
        "3x Kostenfreie MultiSIM",
        "Welcome Pass 1GB für 48 Stunden, 1x im Monat für die Ländergruppe 2 und 3 nutzbar",
        "Security OnNet Basic"
      ]
